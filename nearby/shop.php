...
FROM shop_product,shop
where shop.id=shop_product.shop_id
HAVING distance < 20
ORDER BY distance");
}else{
	$res=mysqli_query($con,"select shop_product.*,shop.shop_name from shop_product,shop where shop.id=smart_gadgets.shop_id");
